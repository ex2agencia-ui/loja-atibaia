...
import { RotateCcw, Pencil, ShieldCheck, ShieldOff, Loader2 } from "lucide-react"
...
export function AcessoSistemaCard({ memberId, membroNome, usuario, isAdmin, onRefresh }: Props) {
